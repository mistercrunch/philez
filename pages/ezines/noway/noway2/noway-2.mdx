...
prises à la dérision et ce n'est pas un mal.
        ...
        Je suis donc très heureux de vous présenter le deuxième numéro de
N0 WAY.  De nouveaux auteurs se sont démenés pour vous présenter des articles
de qualité.  C'est dans une ambiance bizarre que continuent les scènes
...
Services et avaient fait tomber encore plus de personnes.
        ...
        C'est aussi en sachant très bien qu'ils sont monitorés que des
...
développés. Sur les factures des cartes france telecom, il y a même le numéro
...
La téléphonie cellulaire du GSM commence à être analysée et disséquée montrant
...
2.2 : Table des matières                        N0 Way Team               1 Ko
...
révèler son nom ni adresse ni téléphone à quiconque sur le réseau. Puis ayant
...
amis, il échangea son numéro de téléphone avec l'une d'entre elles.
   FINI !   La règle était enfreinte, la magie du réseau était brisée!
...
ils possèdent des relations en grande quantité.

        La DST par contre a une grande mémoire.  Ils peuvent très bien vous
...
On vous couvre si il y a un problème avec la justice (plaintes etc...)
...
vous n'ayez jamais d'ennui.
        ...
        Et telle est la pièce maitresse de leur jeu, LES TAUPES !
...
hors-service?
C'est vrai, ça pourrait être le cas mais ce serait oublier quelque chose:
Les enquètes se divisent en 2 parties:
- enquètes de sécurité (95% des cas)
- enquètes judiciaires (5% des cas)

Les taupes sont TOUJOURS dénichées lors d'enquètes de sécurité, donc si vous
recevez la visite d'une équipe de la DST et qu'ils ne vous font pas faire de
Garde à vue ni de déposition ni ne vous présentent un mandat, il est très
possible que dans quelques temps (le délai peut être de l'ordre du jour ou de
...
Et bien sûr on utilise les taupes lors d'enquètes judiciaires car ce sont les
...
- flatter le pion en lui attribuant un poste, ou meme un grade (c'est purement
  ...
  ("flatter le pion" revient à peu pres a lui "lécher le fion"... hahaha :))
   désolé, je pouvais pas m'en empècher).
...
Au bout d'un certain temps, un pion peut devenir gênant.  Il y a des cas comme
celui là:
...
Ce pion en avait appris trop selon la DST et était devenu gênant.  La solution
...
Vous comprenez maintenant comment une personne peut être arrêtée aussi
facilement.

II. Et c'est pas fini...

        C'est la même chose dans l'informatique ou dans toutes les professions
...
sont les grandes écoles, les écoles d'ingénieurs, les instituts etc...
        ...
        Une fois un pion installé dans une entreprise, la DST est sûre de
...
ne pas pouvoir en devenir un sois même.  C'est plutôt dégradant de faire ce
...
est de vous montrer que vous êtes faibles pour vous transformer en un outil
qui leur sera pratique.

                Protégez vos amis, ne devenez pas un pion...
                ...retrouvez vos amis, cessez d'être un pion

Pour cesser d'être un pion, ca peut être plus facile qu'on ne le pense.
...
D: Donc vous avez accèdé à ces codes?
V: Non, jamais.

D: Vous les avez au moins essayé non?
V: Non, c'était juste marrant de les avoirs, ce qu'il y a après ne
   m'interresse pas.
...
D: Donc vous venez de dire que les codes sont bons, vous êtes donc rentrés sur
   cette machine!!!?!
V: NON.
...
conclusions qui s'imposent de cet article.  Noous sommes les alliés du 21ème
siècle, ne nous laissons pas envahir par les collabos des réseaux ;)
...
─────────────────────────────────────────────────────────────────────────────
 ...
 'Netware' ou 'reseau' ou un truc comme ça.
 ...
 les effaçer).  Normalement GUEST doit fonctionner.  Si le reseau
 ...
 l'admin.
   ...
   La première partie est traduite directement d'un article de The
 Butler parut dans Phrack 35 car cette partie de son article 
 etait très bien:
  Le directory SYS:SYSTEM est utilisé pour l'administration du
 système et contient les fichiers de l'OS netware et des progs à
...
IF...THEN       Executes certain commands, if a specified condition exists.
 ...
 Si quelque chose n'est pas clair essayez differentes manières et
 consultez le HELP qui est très explicite sur les scripts. 
 ...
 access ne sera que très limité).
 ...
 Très utile pour voir si le supervisor est connecté.  Le compte avec
 ...
 gens connectés sous le nom <USER_ID> reçoivent vos messages donc
 ...
 connaitre Novell, il est très bien fait.  Vous pouvez egalement
 l'emporter	chez vous en copiant les fichiers: 'NFOLIO.*' et
 '*.NFO'.  
 - SYSCON : Le meilleur outil de tous.  Vous allez etre
 amener a très bien le connaitre.  Avant de le lancer executer un
 prog du type ScrollIt (shareware) qui permet de capturer l'ecran et
 de la sauvegarder dans un fichier.  Après avoir lançé SYSCON allez
 sur l'option 'User Information' et, abracadabra, voiçi la liste de
 ...
 à l'informatique. Ceci n'est pas du ressort de cet article.
   ...
   B) La meilleure façon: Pour ceci il faut avoir access physique à un
 poste ou se log le supervisor.  Il faut y installer un TSR qui va
 capturer son PW lorsque il se log.  Il y a en gros 2 façons de
 faire ceci:
 ...
 cela il faut que le TSR soit lançé _après_ NETX.  Je pense que avec
 ...
 que tout se passe de façon transparente, mais cela reste à etudier.
 ...
 Le premier est très bien decrit, mais malheureusement je pense que
 ...
 Le problème ici est que le second Int envoit le PW crypté, ce qui
 ne nous est pas très utile car le chiffrement du PW depend d'une
 ...
 aussi etre très utile. 
 De toute façon, cela fait que la première approche (rediriger l'Int
 du clavier) est nettement meilleure si vos PW sont envoyés cryptés.
 
   C) La plus longue façon mais aussi la plus sure: Essayer toutes (ou
 ...
 première methode est sure de trouver le PW eventuellement, mais la
 seconde est beaucoup plus rapide.
 Ensuite, il y a 2 façons d'essayer les PW:
   * En login: Cette manière consiste tout simplement a essayer de se
 logger avec tous les PW jusqu'a trouver le bon.  Il y a un freeware
 qui fait cela avec LOGIN.EXE, mais il est très lent et je ne suit
 ...
 emet un bip.  Le message est à peu près: 'Attempt to send
 ...
 l'on ne decouvre qui l'a ecrit.
	...
	VII) L'après SUPERVISOR et les autres comptes
	~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 ...
 * Tous les PW sont cryptés et sauvegardés dans les Bindery file.
 ...
 vous.  Vous allez maintenant faire une operation chère aux
 ...
 * La deuxième tactique est le packet-sniffing.  Si votre reseau
 ...
 tous les packets qui passent sur le reseau.  De cette manière vous
 pourrez meme lire le mail, les messages par SEND et tout ce qui
 transite pas le reseau.  Cette partie doit vous sembler très floue.
 ...
 Le forum Novell sur FIDO et le Netwire sur Compuserve sont très
 ...
 pas très competent, etc
 Lisez l'article de The Butler dans Phrack 35.  Il est interressant
 d'un point de vu utilisation du système, mais d'un niveau très
 faible.
 ...
 il n'a	pas fait grand chose après son login voici une technique
 pour trouver son PW:
 ...
 le bien car il est assez dense mais très instructif.  Il vient des
...
>Presentation:
=============
   Le Telsat 8x50 est un systême d'assemblage déssassemblage de paquet pour
...
Mais tous ces messages peuvent être modifiés.
...
=============================
Pour acceder à la porte de commande, il y a trois manières:
...
Intro:
-----
    J'ai rassemblé ici tout ce que je savais sur le systême de gestion
...
Ce sont des NRL (Relai) qui, connectés à des centres FT avec opérateurs grâce
à des modems 300 bauds, gerent la transmission des informations de routage
et de taxation.
Aux UGR (lien avec le RTC), il y a des CGM qui gèrent les mobiles et leur
routage.
...
Ils utilisent donc certainnement le systême d'exploitation GECOS de Bull
...
Le mot de la fin:
----------------
    Eh bien, j'espère que ca vous permettra de pas vous retrouver bête devant
le prompt de ce systeme si jamais vous y arrivez un jour...
En tout cas, j'espère pouvoir vous donner plus d'info sur le GECOS d'ici
quelques temps...
Have Phun!					++ NeurAlien
...
sorte que l'on voit des fentes de lumière au dessus des viroles \/.
...
modems).  Ils composaient très vite, pouvait rappeler immédiatement un
numéro et plein d'autres petites fonctionnalités de ce type existaient.

        FT a vu la dedans une menace envers son monopole et hop, pour être
...
Je ne sais pas si les mecs de USR sont au courant de ca mais c'est très bon.

Il est très interressant de bidouiller son modem avec les "reserved" register.
Je donne la liste des ces registers ou des bits reservé de certains registres:
        ...
        - S14   : Dans la série des registres de parametrage de mode, on
                  peut imaginer que ce registre sert à la même chose.
        ...
        - S16   : Paramêtre pour tester son modem: Dial test, Loopback...
                  les bits 4 (16), 5(32) et 6(64) de ce registre sont reservés.
                  le bit 7 (128) est carrement pas liste.
                  Doc Default: 0                French Default: 0

        - S17   : Toujours dans la série des bits de test, ca doit être ca!
                  le registre entier est reservé.
                  Doc Default: 0                French Default: 0
...
Mais la règle d'or pour comprendre est:
...
Nombre de canaux:                       40
Sensibilité recepteur:                  45 dB µV/m pour 0.001 BER  (??????)
...
---------------------------------------------------------
S/N: (Serial Number?) : 10 caractères alphanumériques
ELEC S/N: 12 chiffres
Code de securite principal: 6 chiffres
GPID: 16 caractères alphanumériques
...
simplement le numéro de carte en cas de télépaiement (pour les ignares  ça
...
où l'embossage de la carte était tranféré par carbonne et pour les prises de
commande par téléphone.

II Les pistes magnétiques

Les cartes VISA comportent plusieurs pistes le standard ISO en definie 3, les
cartes françaises en utilisent 4 ISO1, ISO2, et 2 autres propre à la France
T2, et T3 bravo la normalisation... Cependant pour des raisons de compatilitée
et de coût une seule et utilisée à la fois généralement ISO2 mais parfois ISO1
...
Un prochain article intégrera je l'espère le schéma d'un lecteur/écriveur de
piste magnétique, sachez qu'une tête magnétique de magnétophone fait trés bien
...
----DONNEES----   Parité
b1  b2   b3  b4     b5      Caractère     Fonction
...
voici ZORO avec son ANSI/ISO ALPHA FORMAT:
         ...
         --------Données-------   Parité
         b1  b2  b3  b4  b5  b6     b7    Caractère   Fonction
...
et ISO2:
Les pistes T2 et T3 des cartes française 'seraient' un redit des informations
...
PISTE 1
 ...
 13        1         LRC
    ...
    Longueur maximum  79 Caractères
...
caractères précédents sauf STX.



III Le numéro de carte

 Le numéro inscrit sur votre carte est son identitée, c'est avec ça que toutes
...
façon mathématique ce qui permettra de vérifier si le numéro de carte est
...
Une façon trés simple d'avoir un numéro de compte est de regarder votre relevé
...
pour être sur d'un numéro de carte vous pouvez vous connecter sur Compuserve,
...
C'est du brut, libre à vous de rajouter des fioritures mais ça marche c'est le
principal non??
...
être Schlumberger mais pas Gemplus).
La carte est sécurisé par zone, la première zone en accés libre comporte les
informations embossées (Nom, Prenom, Numero, Date d'expiration), la seconde
zone peut être lu après présentation d'un code c'est la zone de transaction,
un compteur comptabilise (comme tout bon compteur) les erreurs de présentation
de code aprés 3 erreurs successives même sur des terminaux diffèrents la
...
Voila j'espère que ce petit fichier vous aura interessé, dans un prochain nous
...
découverte de ce monde qu'est le résau téléphonique.
        ...
        Du peu que j'ai découvert par moi-même et des grandes choses que
...
refuser d'être taxe de 15F et juste demander a quelle société appartient ce
...
==========================
        Décrochez le téléphone d'où vous êtes et composez le 3644, raccrochez,
...
à Hawaii ou a Atlanta. :)
                        ...
                        This is the end, my friend............ ++NeurAlien
                         ...
                         -=- Dis file passed thru -=-

+  /               .                              /     .    .
  /|     *                -o-    .      ' '      /|___.._   /   +
 //____  ____...__   , ______      +    |'|'    /        \ /|    ___  ___  .  '
(      \/        /  / /      \        __||||__  )   .     \\ \__/   \/   \    |
 \_____  ______  \ /\ }  __   }   .  /  .     }/    |\     \\             } _/|
      {  }  /  \ // //  /  \ /      /   |\   /{    /  \     }\   ___/\___/_/  |
    + |  | /|   |/ //   \_  |  '   {    \|  {  \  {    \   /  }  \ .   +  )   |
.     \  /| \___/  |\    _) .  |    \    \   \  \  \    \ {  /    \___.._/    /
 ...
 .    /  //  (  (   \ /  \__/ \|/   \     .   /  | /     =  {     _   .  /
    ...
    +  '    .   '            .   .      '|'|    '        +  BBS .    \/
                 +             '           .  .      .                    .
===============================================================================
Sector 0ne/Eko/FFT/Equinox/Furtive/Eagles WHQ -~- <> -~- Control Team French HQ
==============================> HP 48 World Base <=============================
-=-   P/H/A/C, HP48, Falcon, ST, Amiga, PC warez, hints, Chats, and more.   -=-
==================================> Ring now : <===============================
-=-  [ + 3 3 ] - ( 1 ) 4 9 - 8 8 7 - 6 9 1 -=- 1 Go 0/L -=- Paris / France  -=-
===============================================================================
